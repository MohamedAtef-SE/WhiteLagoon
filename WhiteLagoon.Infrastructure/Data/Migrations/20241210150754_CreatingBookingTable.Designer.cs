...
namespace WhiteLagoon.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241210150754_CreatingBookingTable")]
    partial class CreatingBookingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhiteLagoon.Domain.Entities.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WhiteLagoon.Domain.Entities.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WhiteLagoon.Domain.Entities.Booking", b =>
                {
                    b.HasOne("WhiteLagoon.Domain.Entities.Identity.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
